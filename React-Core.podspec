...
Pod::Spec.new do |s|
  s.name             = 'React-Core'
  s.version          = '0.1.0'
  s.summary          = 'A short description of React-Core.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/sjnscythe/React-Core'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'sjnscythe' => 'scytheabhi97@gmail.com' }
  s.source           = { :git => 'https://github.com/sjnscythe/React-Core.git', :tag => s.version.to_s }
